      ...
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <NumberInput
            ...
            formControlProps={{
              id: 'player_limit',
              isInvalid: !!formik.errors?.player_limit,
            }}
            name="player_limit"
            error={formik.errors?.player_limit}
            value={formik.values?.player_limit}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('player_limit', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
