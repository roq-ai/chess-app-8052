...
export function GameListPage(props: GameListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getGames({
        relations: ['company', 'user', 'game_player.count', 'player.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['name.contains', 'rules.contains', 'status.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'player_limit', header: 'player_limit', accessorKey: 'player_limit' },
    ...
    hasAccess('game_player', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'game_player',
          header: 'Game Player',
          accessorKey: 'game_player',
          cell: ({ row: { original: record } }: any) => record?._count?.game_player,
        }
      : null,
