  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Chess App - Your gateway to engaging two-player chess battles, seamlessly connecting over any wifi network."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Chess App - Your gateway to engaging two-player chess battles, seamlessly connecting over any wifi network.`}
            </Text>
            <Box
