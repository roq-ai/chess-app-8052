...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  ...
  'game.update': { roles: ['application-owner'], key: 'game-updated', tenantPath: ['company', 'game'], userPath: [] },
  'game.delete': { roles: ['application-owner'], key: 'game-deleted', tenantPath: ['company', 'game'], userPath: [] },
  'game_player.create': {
    roles: ['application-owner', 'game-administrator'],
    key: 'player-assigned',
    tenantPath: ['company', 'game', 'player', 'game_player'],
    userPath: [],
  },
  'game_player.delete': {
    roles: ['application-owner', 'game-administrator'],
